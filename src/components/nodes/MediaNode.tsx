      ...
      <div className="p-4">
        {url ? <div className="relative group rounded-xl overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
              {nodeData.libraryPrompt && <Button variant="secondary" size="icon" className="h-9 w-9" onClick={() => {
            ...
            toast({
              ...
              <Button variant="destructive" size="icon" className="h-9 w-9" onClick={() => handleUrlChange(null)}>
                <X className="h-4 w-4" />
              </Button>
            </div>
